...
#define CMD_SET_AUTO    21 //Właczenie trybu automatycznego parametr ON - wł OFF wył
#define CMD_SET_SPEED   22 //Ustawienia obrótów silnika parametr SPEED1, SPEED2, SPEED3, SPEED4, SPEED5

//Rezerwacja w wersji nr 2
#define CMD_GET_BATTERY 23 //Wysyłanie do Mastera odczytu onapięcia na baterii
#define CMD_SET_LIGHT   24 //Sterowanie oświetleniem parametr ON - wł OFF wył 

//Rezerwacja w wersji nr 2
#define CMD_SET_EYES    25 //Ustawienie kierunków oczów parametr kąt 1-180

//Rezerwacja w wersji nr 2
#define CMD_GET_EYES    26 //Wysyłanie do Mastera odczytu odległości 0 -255 cm
